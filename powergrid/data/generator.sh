...
tc large-1 gen_random n=$MAXN m=$MAXN maxc=$MAXN
tc large-2 gen_random n=$MAXN m=997 maxc=$MAXN
tc large-3 gen_random n=$MAXN m=944 maxc=$MAXN
tc large-4 gen_random n=$MAXN m=900 maxc=$MAXN
tc large-5 gen_random n=$MAXN m=100 maxc=$MAXN
tc large-6 gen_random n=$MAXN m=2 maxc=$MAXN
tc large-7 gen_random n=201 m=$MAXN maxc=$MAXN
tc large-8 gen_random n=111 m=$MAXN maxc=$MAXN
tc large-9 gen_random n=999 m=$MAXN maxc=$MAXN
